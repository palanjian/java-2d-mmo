...
public class NonPlayerHandler implements Runnable{
	...
	public void draw(Graphics2D g2) {
		for(PlayerInfo p : allPlayerInfos.values()) {
			Map<Integer, BufferedImage> spriteMap = allPlayerSprites.get(p.getId());
			BufferedImage image = spriteMap.get(0); //default value
	...
	public void addPlayerSprite(PlayerInfo player) {
		...
		spriteMap = SpriteHandler.getSpriteMap(spritesheet, 4, 4, gamePanel.getOriginalTileSize());
